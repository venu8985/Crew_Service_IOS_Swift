//
//  ReceviedQuoteViewController.swift
//  TasmemcomUser
//
...
class ReceviedQuoteViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func ListAPICall(Currentpage:Int){
        CommonAPI.shared.hireresourcerequests(parameters: [CWeb.page:Currentpage,CWeb.type:"ongoing"],isShow:self.List.count == 0) { mainData in
...
extension ReceviedQuoteViewController: JXSegmentedListContainerViewListDelegate {
