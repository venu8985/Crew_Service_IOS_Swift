...
public final class CVAuxiliaryView: UIView {
    ...
    fileprivate var radius: CGFloat {
        return (min(frame.height, frame.width) - 20) / 2
    }
...
//        let offset = appearance.spaceBetweenDayViews!
    ...
    func rectPath() -> UIBezierPath {
        ...
        let path = UIBezierPath(roundedRect: CGRect(x: midX - radius, y: midY - radius,
            width: radius * 2, height: radius * 2),cornerRadius: 5)
