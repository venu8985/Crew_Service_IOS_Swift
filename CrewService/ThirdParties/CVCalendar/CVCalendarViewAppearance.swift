...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdayFont: UIFont? = UIFont(name: "AvenirLTStd-Black", size: 18)
    public var dayLabelPresentWeekdayFont: UIFont? = UIFont(name: "AvenirLTStd-Black", size: 18)
    public var dayLabelPresentWeekdayBoldFont: UIFont? = UIFont(name: "AvenirLTStd-Black", size: 18)
    public var dayLabelPresentWeekdayHighlightedFont: UIFont? =
        UIFont(name: "AvenirLTStd-Black", size: 18)
    public var dayLabelPresentWeekdaySelectedFont: UIFont? = UIFont(name: "AvenirLTStd-Black", size: 18)
    public var dayLabelWeekdayHighlightedFont: UIFont? = UIFont(name: "AvenirLTStd-Black", size: 18)
    public var dayLabelWeekdaySelectedFont: UIFont? = UIFont(name: "AvenirLTStd-Black", size: 18)
    /// Default text color.
